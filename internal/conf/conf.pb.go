...
func (x *Bootstrap) GetFilter() *Filter {
	if x != nil {
		return x.Filter
	}
	return nil
...
type Filter struct {
	...
	Bloom *Filter_Bloom `protobuf:"bytes,1,opt,name=bloom,proto3" json:"bloom,omitempty"`
}
...
func (x *Filter) GetBloom() *Filter_Bloom {
	if x != nil {
		return x.Bloom
	}
	return nil
...
type Filter_Bloom struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	ElementNumer uint32  `protobuf:"varint,1,opt,name=elementNumer,proto3" json:"elementNumer,omitempty"`
	ErrorRate    float32 `protobuf:"fixed32,2,opt,name=errorRate,proto3" json:"errorRate,omitempty"`
}

func (x *Filter_Bloom) Reset() {
	*x = Filter_Bloom{}
	if protoimpl.UnsafeEnabled {
...
func (x *Filter_Bloom) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*Filter_Bloom) ProtoMessage() {}

func (x *Filter_Bloom) ProtoReflect() protoreflect.Message {
	mi := &file_conf_conf_proto_msgTypes[8]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use Filter_Bloom.ProtoReflect.Descriptor instead.
func (*Filter_Bloom) Descriptor() ([]byte, []int) {
	return file_conf_conf_proto_rawDescGZIP(), []int{3, 0}
}

func (x *Filter_Bloom) GetElementNumer() uint32 {
	if x != nil {
		return x.ElementNumer
	}
	return 0
}

func (x *Filter_Bloom) GetErrorRate() float32 {
	if x != nil {
		return x.ErrorRate
	}
	return 0
...
var file_conf_conf_proto_rawDesc = []byte{
	...
	0x06, 0x66, 0x69, 0x6c, 0x74, 0x65, 0x72, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x12, 0x2e,
	0x6b, 0x72, 0x61, 0x74, 0x6f, 0x73, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x46, 0x69, 0x6c, 0x74, 0x65,
	0x72, 0x52, 0x06, 0x66, 0x69, 0x6c, 0x74, 0x65, 0x72, 0x22, 0xb8, 0x02, 0x0a, 0x06, 0x53, 0x65,
	...
	,
...
var file_conf_conf_proto_goTypes = []interface{}{
	...
	(*Filter)(nil),              // 3: kratos.api.Filter
	...
	(*Filter_Bloom)(nil),        // 8: kratos.api.Filter.Bloom
	(*durationpb.Duration)(nil), // 9: google.protobuf.Duration
}
var file_conf_conf_proto_depIdxs = []int32{
	1,  // 0: kratos.api.Bootstrap.server:type_name -> kratos.api.Server
	2,  // 1: kratos.api.Bootstrap.data:type_name -> kratos.api.Data
	3,  // 2: kratos.api.Bootstrap.filter:type_name -> kratos.api.Filter
	...
	8,  // 7: kratos.api.Filter.bloom:type_name -> kratos.api.Filter.Bloom
